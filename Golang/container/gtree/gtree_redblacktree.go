...
func NewRedBlackTree(comparator func(v1, v2 interface{}) int) *RedBlackTree {
	return &RedBlackTree{
		mu:         sync.RWMutex{},
...
// The parameter `safe` is used to specify whether using tree in concurrent-safety,
// which is false in default.
func NewRedBlackTreeFrom(comparator func(v1, v2 interface{}) int, data map[interface{}]interface{}) *RedBlackTree {
...
func (tree *RedBlackTree) Clone() *RedBlackTree {
	newTree := NewRedBlackTree(tree.comparator)
...
func (tree *RedBlackTree) GetVar(key interface{}) interface{} {
	return tree.Get(key)
}

// GetVarOrSet returns a gvar.Var with result from GetVarOrSet.
// The returned gvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSet(key interface{}, value interface{}) interface{} {
	return tree.GetOrSet(key, value)
}

// GetVarOrSetFunc returns a gvar.Var with result from GetOrSetFunc.
// The returned gvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFunc(key interface{}, f func() interface{}) interface{} {
	return tree.GetOrSetFunc(key, f)
}

// GetVarOrSetFuncLock returns a gvar.Var with result from GetOrSetFuncLock.
// The returned gvar.Var is un-concurrent safe.
func (tree *RedBlackTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) interface{} {
	return tree.GetOrSetFuncLock(key, f)
}
...
func (tree *RedBlackTree) Flip(comparator ...func(v1, v2 interface{}) int) {
	t := (*RedBlackTree)(nil)
	if len(comparator) > 0 {
		t = NewRedBlackTree(comparator[0])
	} else {
		t = NewRedBlackTree(tree.comparator)
	}
	tree.IteratorAsc(func(key, value interface{}) bool {
		t.doSet(value, key)
		return true
...
func (tree RedBlackTree) MarshalJSON() ([]byte, error) {
	return json.Marshal(Map(tree.Map()))
}
...
func (tree *RedBlackTree) UnmarshalJSON(b []byte) error {
	...
	if tree.comparator == nil {
		tree.comparator = ComparatorString
	}
