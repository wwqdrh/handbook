...
func NewAVLTree(comparator func(v1, v2 interface{}) int) *AVLTree {
	return &AVLTree{
		mu:         sync.RWMutex{},
...
// The parameter `safe` is used to specify whether using tree in concurrent-safety,
// which is false in default.
func NewAVLTreeFrom(comparator func(v1, v2 interface{}) int, data map[interface{}]interface{}) *AVLTree {
	tree := NewAVLTree(comparator)
	for k, v := range data {
...
func (tree *AVLTree) Clone() *AVLTree {
	newTree := NewAVLTree(tree.comparator)
...
func (tree *AVLTree) GetVar(key interface{}) interface{} {
	return tree.Get(key)
}

// GetVarOrSet returns a gvar.Var with result from GetVarOrSet.
// The returned gvar.Var is un-concurrent safe.
func (tree *AVLTree) GetVarOrSet(key interface{}, value interface{}) interface{} {
	return tree.GetOrSet(key, value)
}

// GetVarOrSetFunc returns a gvar.Var with result from GetOrSetFunc.
// The returned gvar.Var is un-concurrent safe.
func (tree *AVLTree) GetVarOrSetFunc(key interface{}, f func() interface{}) interface{} {
	return tree.GetOrSetFunc(key, f)
}

// GetVarOrSetFuncLock returns a gvar.Var with result from GetOrSetFuncLock.
// The returned gvar.Var is un-concurrent safe.
func (tree *AVLTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) interface{} {
...
func (tree *AVLTree) Flip(comparator ...func(v1, v2 interface{}) int) {
	t := (*AVLTree)(nil)
	if len(comparator) > 0 {
		t = NewAVLTree(comparator[0])
	} else {
		t = NewAVLTree(tree.comparator)
	}
	tree.IteratorAsc(func(key, value interface{}) bool {
