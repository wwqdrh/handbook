...
func NewBTree(m int, comparator func(v1, v2 interface{}) int) *BTree {
	if m < 3 {
...
// The parameter `safe` is used to specify whether using tree in concurrent-safety,
// which is false in default.
func NewBTreeFrom(m int, comparator func(v1, v2 interface{}) int, data map[interface{}]interface{}) *BTree {
	tree := NewBTree(m, comparator)
	for k, v := range data {
		tree.doSet(k, v)
	}
	return tree
...
func (tree *BTree) Clone() *BTree {
	newTree := NewBTree(tree.m, tree.comparator)
...
func (tree *BTree) GetVar(key interface{}) interface{} {
	return tree.Get(key)
}

// GetVarOrSet returns a gvar.Var with result from GetVarOrSet.
// The returned gvar.Var is un-concurrent safe.
func (tree *BTree) GetVarOrSet(key interface{}, value interface{}) interface{} {
	return tree.GetOrSet(key, value)
}

// GetVarOrSetFunc returns a gvar.Var with result from GetOrSetFunc.
// The returned gvar.Var is un-concurrent safe.
func (tree *BTree) GetVarOrSetFunc(key interface{}, f func() interface{}) interface{} {
	return tree.GetOrSetFunc(key, f)
}

// GetVarOrSetFuncLock returns a gvar.Var with result from GetOrSetFuncLock.
// The returned gvar.Var is un-concurrent safe.
func (tree *BTree) GetVarOrSetFuncLock(key interface{}, f func() interface{}) interface{} {
