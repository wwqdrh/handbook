...
_ROUTESUMMARY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="point_count",
            full_name="RouteSummary.point_count",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="feature_count",
            full_name="RouteSummary.feature_count",
            index=1,
            number=2,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="distance",
            full_name="RouteSummary.distance",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="elapsed_time",
            full_name="RouteSummary.elapsed_time",
            index=3,
            number=4,
            type=5,
            cpp_type=1,
