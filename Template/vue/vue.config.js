...
module.exports = {
    publicPath: '/',
    pages: getEntry('./src/apps/*/main.js'),
    outputDir: 'dist',
    assetsDir: 'static',
    ...
    configureWebpack: {
        ...
        resolve: {
            alias: {
                '@': resolve('src'),
                '@admin': resolve('src/apps/admin'),
                '@index': resolve('src/apps/index'),
            }
        },
    },
    chainWebpack(config) {
